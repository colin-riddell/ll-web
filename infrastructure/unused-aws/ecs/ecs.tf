...
# a Security Group to avoid external connections to the containers.
...
#  accepts traffic from the NLB and routes traffic to the containers??
...
# create a Load Balancer Target Group for ALB, it will relate the Load Balancer with the Containers.
